...
const SKILLS_SECTIONS = [
    { icon: <Code className="w-6 h-6" />, title: "Programming Languages", tags: ["SQL", "Python","HTML"] },
    { icon: <Layers className="w-6 h-6" />, title: "Data Analysis", tags: ["Microsoft Excel", "Data Visualization", "Power Query", "Pivot Table "] },
    { icon: <Terminal className="w-6 h-6" />, title: "Business Intelligence", tags: ["Power Bi", "Data Modeling", "Interactive Dashboards"] },
    { icon: <Sparkles className="w-6 h-6" />, title: "Interests", tags: ["Data Analytics", "Business Intelligence", "Machine Learning", "Artificial Intelligence"] },
];
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
               Here are the technical skills and areas I have developed through my university studies and practical projects in data analytics and artificial intelligence.
            </p>
        </motion.div>
